...
import com.example.workoutbasic.adapters.Workouts.WorkoutAdapter;
...
public class HistoryFragment extends NavigationFragment implements NestedListenerPasser, ButtonOptions {
    ...
    public void setListeners() {
        doubleClickListener = createIntentClickListener();
        onLongClickListener = createLongClickListener();
        workoutButton.setOnClickListener(createWorkoutButtonListener());
    }
    ...
    private DoubleClickListener createIntentClickListener() {
        return position -> childPos -> {
    ...
    protected DoubleClickListener createDoubleCLickListener() {
    ...
    protected View.OnClickListener createWorkoutButtonListener() {
        return v -> {
            Bundle bundle = new Bundle();
